...
case "$FULL_HOSTNAME" in
    ...
    *"polaris"* )
	...
	MPS_START_FILE=/eagle/hpe_dragon_collab/csimpson/enable_mps_polaris.sh
...
if [[ -n $POLARIS || -n $SIRIUS ]]; then
    ...
    # mpiexec -n ${NODES} --ppn 1 ${MPS_START_FILE}
    # 4 MPS threads per gpu
    # export GPU_DEVICES="3,3,3,3,2,2,2,2,1,1,1,1,0,0,0,0"
    # export CPU_AFFINITY="list:0-1,32-33:2-3,34-35:4-5,36-37:6-7,38-39:8-9,40-41:10-11,42-43:12-13,44-45:14-15,46-47:16-17,48-49:18-19,50-51:20-21,52-53:22-23,54-55:24-25,56-57:26-27,58-59:28-29,60-61:30-31,62-63"

    # 1 MPS thread per gpu
