...
do
    python data_loader_mp.py --data_path=${DATA_PATH_SMALL} --mp_launch=spawn --granularity=${G} --validate=no
done
echo
...
for G in "directory" "directory_file" "file"
do
    dragon data_loader_mp.py --data_path=${DATA_PATH_SMALL} --mp_launch=dragon --granularity=${G} --validate=no
done
echo
echo
...
for G in "directory" "directory_file" "file"
do
    python data_loader_mp.py --data_path=${DATA_PATH_MED} --mp_launch=spawn --granularity=${G} --validate=no
done
echo
...
for G in "directory" "directory_file" "file"
do
    dragon data_loader_mp.py --data_path=${DATA_PATH_MED} --mp_launch=dragon --granularity=${G} --validate=no
done
echo
...
for G in "directory" "directory_file" "file"
do
    python $EXE_PATH/data_loader_mp.py --data_path=${DATA_PATH_LARGE} --mp_launch=spawn --granularity=${G} --validate=no
done
echo
...
for G in "directory" "directory_file" "file"
do
    dragon $EXE_PATH/data_loader_mp.py --data_path=${DATA_PATH_LARGE} --mp_launch=dragon --granularity=${G} --validate=no
done
echo
