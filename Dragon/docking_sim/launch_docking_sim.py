...
from .docking_openeye import docking_switch, run_docking
...
def launch_docking_switch(cdd: DDict, nodelist, num_procs: int, continue_event):
    """Launch the docking simulation switch for async workflow
